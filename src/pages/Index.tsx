    ...
    <div className="font-sans text-foreground bg-cream min-h-screen">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <img src={surfCampLogo} alt="Mad Monkey Surf Camp Kuta Lombok" className="w-72 md:w-[28rem] mx-auto mb-8 drop-shadow-2xl <img src={surfCampLogo} alt="Mad Monkey Surf Camp Kuta Lombok" className="w-72 md:w-[28rem] mx-auto mb-8 drop-shadow-2xl" />" />
