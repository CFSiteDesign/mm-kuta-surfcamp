    ...
    <div className="font-sans text-foreground bg-cream min-h-screen">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[200%] z-10 animate-wave">
          <svg viewBox="0 0 2880 120" preserveAspectRatio="none" className="w-full block h-[60px] md:h-[100px]">
            <path d="M0,60 C60,20 120,20 180,60 C240,100 300,100 360,60 C420,20 480,20 540,60 C600,100 660,100 720,60 C780,20 840,20 900,60 C960,100 1020,100 1080,60 C1140,20 1200,20 1260,60 C1320,100 1380,100 1440,60 C1500,20 1560,20 1620,60 C1680,100 1740,100 1800,60 C1860,20 1920,20 1980,60 C2040,100 2100,100 2160,60 C2220,20 2280,20 2340,60 C2400,100 2460,100 2520,60 C2580,20 2640,20 2700,60 C2760,100 2820,100 2880,60 L2880,120 L0,120 Z" fill="hsl(24,60%,97%)" />
          </svg>
        </div>
      </section>
